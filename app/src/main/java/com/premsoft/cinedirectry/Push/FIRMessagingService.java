...
import com.premsoft.cinedirectry.UI.CustomeWebView;
import com.premsoft.cinedirectry.UI.DailogeNotice;
import com.premsoft.cinedirectry.UI.MainActivity;
...
//			editor.commit();
    ...
    private class DisplayToast implements Runnable {
        ...
        public void run() {
            Toast.makeText(FIRMessagingService.this, mText, Toast.LENGTH_LONG)
                    .show();
        }
    }
